                ...
                components: [
                  ...new DesignerToolbarSettings()
                    ...
                    .addCollapsiblePanel({
                      ...
                      ghost: true,
                      collapsible: 'header',
                      showStyleModeToggle: true,
                      content: {
                        id: nanoid(),
                        components: [...new DesignerToolbarSettings()
                          .addPropertyRouter({
                            id: nanoid(),
                            propertyName: 'styleModeRouter',
                            componentName: 'propertyRouter',
                            label: 'Style mode router',
                            labelAlign: 'right',
                            hidden: false,
                            propertyRouteName: {
                              _mode: "code",
                              _code: "const device = contexts.canvasContext?.designerDevice || 'desktop'; const mode = contexts.settingsFormContext?.styleMode === 'hover' ? 'hoverStyles' : 'styles'; return `${device}.${mode}`;",
                              _value: "",
                            },
                            components: [
                              ...new DesignerToolbarSettings()
                        ...
                        components: [
                          ...new DesignerToolbarSettings()
                            .addPropertyRouter({
                              ...
                              propertyRouteName: {
                                _mode: "code",
                                _code: "return contexts.settingsFormContext?.styleMode === 'hover' ? 'hoverStyles' : 'styles';",
                                _value: "",
                              },
                              components: [
                                ...new DesignerToolbarSettings()
